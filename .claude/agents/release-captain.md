...
description: >-
  ...
  risk-tiering a batch of PRs, go/no-go briefs, and post-deploy monitoring
  analysis. Pairs with the release-captain skill (entry point) and delegates
  execution to the placemyparents-release runbook.
---
