-- 1984 Orwellian colorscheme for Neovim
-- Warm ration-brown ground, telescreen cyan, to match the kitty theme

vim.cmd("hi clear")
if vim.fn.exists("syntax_on") then
  vim.cmd("syntax reset")
end
vim.g.colors_name = "1984-orwellian"
...
hi("DiffDelete",   { fg = p.error, bg = p.none })
...
hi("@comment.error",      { fg = p.bg, bg = p.error, bold = true })
...
hi("DiagnosticSignError",     { fg = p.error, bg = p.none })
...
hi("GitSignsDelete",    { fg = p.error, bg = p.none })
