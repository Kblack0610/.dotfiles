---
description: 'Stay autonomous for the rest of the task — chain through every checkpoint with best-judgment,
  record assumptions, stop only at hard gates. Scope: $ARGUMENTS'
---
