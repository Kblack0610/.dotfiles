...
--Chat
vim.keymap.set({ "n", "i" }, "<leader>ss", "<cmd>GpChatNew vsplit<cr>", keymapOptions("New Chat vsplit"))
...
--
-- --Agents
vim.keymap.set({"n", "i", "v", "x"}, "<leader>sl", "<cmd>GpStop<cr>", keymapOptions("Stop"))
vim.keymap.set({"n", "i", "v", "x"}, "<leader>sn", "<cmd>GpNextAgent<cr>", keymapOptions("Next Agent"))
